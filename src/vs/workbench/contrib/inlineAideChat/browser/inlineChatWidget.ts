...
import { ChatModel, IChatModel } from '../../../../workbench/contrib/aideChat/common/aideChatModel.js';
import { isResponseVM, isWelcomeVM } from '../../../../workbench/contrib/aideChat/common/aideChatViewModel.js';
import { HunkInformation, Session } from '../../../../workbench/contrib/inlineAideChat/browser/inlineChatSession.js';
import { CTX_INLINE_CHAT_FOCUSED, CTX_INLINE_CHAT_RESPONSE_FOCUSED, inlineChatBackground, InlineChatConfigKeys, inlineChatForeground } from '../../../../workbench/contrib/inlineAideChat/common/inlineChat.js';
import { ChatWidget } from '../../../../workbench/contrib/aideChat/browser/aideChatWidget.js';
import { chatRequestBackground } from '../../../../workbench/contrib/aideChat/common/aideChatColors.js';
...
import { IChatWidgetViewOptions } from '../../../../workbench/contrib/aideChat/browser/aideChat.js';
...
export class InlineChatWidget {
	...
	constructor(
		...
		this._defaultChatModel = this._store.add(this._instantiationService.createInstance(ChatModel, undefined, AideChatAgentLocation.Editor));
...
export class EditorBasedInlineChatWidget extends InlineChatWidget {
	...
	constructor(
		...
		@IAideChatService chatService: IAideChatService,
