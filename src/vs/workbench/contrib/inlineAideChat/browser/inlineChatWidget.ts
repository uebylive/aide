...
import { ChatModel, IChatModel } from 'vs/workbench/contrib/aideChat/common/aideChatModel';
import { isResponseVM, isWelcomeVM } from 'vs/workbench/contrib/aideChat/common/aideChatViewModel';
import { HunkInformation, Session } from 'vs/workbench/contrib/inlineAideChat/browser/inlineChatSession';
import { CTX_INLINE_CHAT_FOCUSED, CTX_INLINE_CHAT_RESPONSE_FOCUSED, inlineChatBackground, InlineChatConfigKeys, inlineChatForeground } from 'vs/workbench/contrib/inlineAideChat/common/inlineChat';
import { ChatWidget } from 'vs/workbench/contrib/aideChat/browser/aideChatWidget';
import { chatRequestBackground } from 'vs/workbench/contrib/aideChat/common/aideChatColors';
...
import { IChatWidgetViewOptions } from 'vs/workbench/contrib/aideChat/browser/aideChat';
