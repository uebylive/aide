...
import { CompletionItemKind, CompletionList, TextEdit } from '../../../../editor/common/languages.js';
...
import { IInlineAideChatSavingService } from './inlineChatSavingService.js';
import { EmptyResponse, ErrorResponse, ReplyResponse, Session, SessionPrompt } from '../../../../workbench/contrib/inlineAideChat/browser/inlineChatSession.js';
import { IInlineAideChatSessionService } from './inlineChatSessionService.js';
import { EditModeStrategy, IEditObserver, LiveStrategy, PreviewStrategy, ProgressingEditsOptions } from '../../../../workbench/contrib/inlineAideChat/browser/inlineChatStrategies.js';
import { InlineChatZoneWidget } from './inlineChatZoneWidget.js';
import { CTX_INLINE_CHAT_REQUEST_IN_PROGRESS, CTX_INLINE_CHAT_RESPONSE_TYPE, CTX_INLINE_CHAT_USER_DID_EDIT, CTX_INLINE_CHAT_VISIBLE, EditMode, INLINE_CHAT_ID, InlineChatConfigKeys, InlineChatResponseType } from '../../../../workbench/contrib/inlineAideChat/common/inlineChat.js';
import { StashedSession } from './inlineChatSession.js';
import { IModelDeltaDecoration, ITextModel, IValidEditOperation } from '../../../../editor/common/model.js';
import { InlineChatContentWidget } from '../../../../workbench/contrib/inlineAideChat/browser/inlineChatContentWidget.js';
import { MessageController } from '../../../../editor/contrib/message/browser/messageController.js';
import { ChatModel, ChatRequestRemovalReason, IChatRequestModel, IChatTextEditGroup, IChatTextEditGroupState, IResponse } from '../../../../workbench/contrib/aideChat/common/aideChatModel.js';
import { InlineChatError } from '../../../../workbench/contrib/inlineAideChat/browser/inlineChatSessionServiceImpl.js';
...
export class InlineChatController implements IEditorContribution {
	...
	constructor(
		...
		this._ui = new Lazy(() => {
			let location = AideChatAgentLocation.Editor;
			...
			for (const notebookEditor of notebookEditorService.listNotebookEditors()) {
				for (const [, codeEditor] of notebookEditor.codeEditors) {
					if (codeEditor === this._editor) {
						location = AideChatAgentLocation.Notebook;
						break;
					}
				}
			}
