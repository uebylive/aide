...
import { InlineChatController, InlineChatRunOptions } from 'vs/workbench/contrib/inlineAideChat/browser/inlineChatController';
import { ACTION_ACCEPT_CHANGES, CTX_INLINE_CHAT_HAS_AGENT, CTX_INLINE_CHAT_HAS_STASHED_SESSION, CTX_INLINE_CHAT_FOCUSED, CTX_INLINE_CHAT_INNER_CURSOR_FIRST, CTX_INLINE_CHAT_INNER_CURSOR_LAST, CTX_INLINE_CHAT_VISIBLE, CTX_INLINE_CHAT_OUTER_CURSOR_POSITION, CTX_INLINE_CHAT_USER_DID_EDIT, CTX_INLINE_CHAT_DOCUMENT_CHANGED, CTX_INLINE_CHAT_EDIT_MODE, EditMode, MENU_INLINE_CHAT_WIDGET_STATUS, CTX_INLINE_CHAT_REQUEST_IN_PROGRESS, CTX_INLINE_CHAT_RESPONSE_TYPE, InlineChatResponseType, ACTION_REGENERATE_RESPONSE, MENU_INLINE_CHAT_CONTENT_STATUS, ACTION_VIEW_IN_CHAT, ACTION_TOGGLE_DIFF, CTX_INLINE_CHAT_CHANGE_HAS_DIFF, CTX_INLINE_CHAT_CHANGE_SHOWS_DIFF } from 'vs/workbench/contrib/inlineAideChat/common/inlineChat';
...
CommandsRegistry.registerCommandAlias('interactiveEditor.start', 'inlineAideChat.start');
...
export class ArrowOutDownAction extends AbstractInlineChatAction {
	constructor() {
		super({
			id: 'inlineAideChat.arrowOutDown',
...
export class DiscardHunkAction extends AbstractInlineChatAction {
	...
	constructor() {
		super({
			id: 'inlineAideChat.discardHunkChange',
			title: localize('discard', 'Discard'),
...
export class MoveToNextHunk extends AbstractInlineChatAction {
	...
	constructor() {
		super({
			id: 'inlineAideChat.moveToNextHunk',
...
export class MoveToPreviousHunk extends AbstractInlineChatAction {
	...
	constructor() {
		super({
			id: 'inlineAideChat.moveToPreviousHunk',
...
export class CopyRecordings extends AbstractInlineChatAction {
	...
	constructor() {
		super({
			id: 'inlineAideChat.copyRecordings',
			f1: true,
	...
	override async runInlineChatCommand(accessor: ServicesAccessor): Promise<void> {
		...
		const ieSessionService = accessor.get(IInlineAideChatSessionService);
