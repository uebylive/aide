...
import { AbstractInlineChatAction, setHoldForSpeech } from 'vs/workbench/contrib/inlineAideChat/browser/inlineChatActions';
import { disposableTimeout } from 'vs/base/common/async';
import { EditorContextKeys } from 'vs/editor/common/editorContextKeys';
import { ICommandService } from 'vs/platform/commands/common/commands';
import { IKeybindingService } from 'vs/platform/keybinding/common/keybinding';
import { StartVoiceChatAction, StopListeningAction, VOICE_KEY_HOLD_THRESHOLD } from 'vs/workbench/contrib/aideChat/electron-sandbox/actions/aideVoiceChatActions';
import { IChatExecuteActionContext } from 'vs/workbench/contrib/aideChat/browser/actions/aideChatExecuteActions';
import { CTX_INLINE_CHAT_VISIBLE, InlineChatConfigKeys } from 'vs/workbench/contrib/inlineAideChat/common/inlineChat';
