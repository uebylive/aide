...
export class ChatRequestParser {
	constructor(
		@IAideAgentAgentService private readonly agentService: IAideAgentAgentService,
		@IAideAgentVariablesService private readonly variableService: IAideAgentVariablesService,
		@IAideAgentSlashCommandService private readonly slashCommandService: IAideAgentSlashCommandService,
