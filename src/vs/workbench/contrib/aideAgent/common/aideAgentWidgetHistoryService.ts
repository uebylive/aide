...
export interface IAideAgentWidgetHistoryService {
...
export class ChatWidgetHistoryService implements IAideAgentWidgetHistoryService {
	_serviceBrand: undefined;
	...
	constructor(
		...
		this.memento = new Memento('aide-agent-session', storageService);
