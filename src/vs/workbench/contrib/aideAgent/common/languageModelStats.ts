...
export const IAideAgentLMStatsService = createDecorator<IAideAgentLMStatsService>('IAideAgentLMStatsService');

export interface IAideAgentLMStatsService {
...
export class LanguageModelStatsService extends Disposable implements IAideAgentLMStatsService {
