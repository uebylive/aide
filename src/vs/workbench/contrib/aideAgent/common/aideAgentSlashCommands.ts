...
import { IChatFollowup, IChatProgress, IChatResponseProgressFileTreeData } from './aideAgentService.js';
...
export const IAideAgentSlashCommandService = createDecorator<IAideAgentSlashCommandService>('aideAgentSlashCommandService');

/**
 * This currently only exists to drive /clear and /help
 */
export interface IAideAgentSlashCommandService {
...
export class ChatSlashCommandService extends Disposable implements IAideAgentSlashCommandService {
