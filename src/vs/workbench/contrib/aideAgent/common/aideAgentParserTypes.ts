...
import { ChatAgentLocation, IChatAgentCommand, IChatAgentData, IAideAgentAgentService, reviveSerializedAgent } from './aideAgentAgents.js';
import { IChatSlashData } from './aideAgentSlashCommands.js';
...
export function formatChatQuestion(chatAgentService: IAideAgentAgentService, location: ChatAgentLocation, prompt: string, participant: string | null = null, command: string | null = null): string | undefined {
	let question = '';
