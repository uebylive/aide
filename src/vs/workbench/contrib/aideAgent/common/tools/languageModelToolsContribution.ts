...
import { IAideAgentLMToolsService, IToolData } from '../languageModelToolsService.js';
...
export class LanguageModelToolsExtensionPointHandler implements IWorkbenchContribution {
	static readonly ID = 'workbench.contrib.aideAgentLMToolsExtensionPointHandler';

	private _registrationDisposables = new DisposableMap<string>();

	constructor(
		@IAideAgentLMToolsService languageModelToolsService: IAideAgentLMToolsService,
