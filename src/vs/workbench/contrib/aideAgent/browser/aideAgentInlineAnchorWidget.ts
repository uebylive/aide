...
export class InlineAnchorWidget extends Disposable {
	...
	constructor(
		...
		if (data.kind === 'symbol') {
			...
			contextMenuId = MenuId.AideAgentInlineSymbolAnchorContext;
			...
			location = data;
			contextMenuId = MenuId.AideAgentInlineResourceAnchorContext;
...
registerAction2(class GoToDefinitionAction extends Action2 {
	...
	static readonly id = 'aideAgent.inlineResourceAnchor.attachToContext';
...
registerAction2(class GoToDefinitionAction extends Action2 {
	...
	constructor() {
		super({
			...
			menu: [{
				id: MenuId.AideAgentInlineSymbolAnchorContext,
				group: 'navigation',
				order: 1.1,
			},]
		});
