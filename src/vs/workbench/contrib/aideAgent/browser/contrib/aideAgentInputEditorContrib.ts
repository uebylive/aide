...
import { dynamicVariableDecorationType } from './aideAgentDynamicVariables.js';
import { IChatAgentCommand, IChatAgentData, IAideAgentAgentService } from '../../common/aideAgentAgents.js';
import { chatSlashCommandBackground, chatSlashCommandForeground } from '../../common/aideAgentColors.js';
import { ChatRequestAgentPart, ChatRequestAgentSubcommandPart, ChatRequestSlashCommandPart, ChatRequestTextPart, ChatRequestToolPart, ChatRequestVariablePart, IParsedChatRequestPart, chatAgentLeader, chatSubcommandLeader } from '../../common/aideAgentParserTypes.js';
