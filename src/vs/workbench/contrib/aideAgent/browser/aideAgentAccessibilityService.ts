...
import { IAideAgentAccessibilityService } from './aideAgent.js';
...
export class AideAgentAccessibilityService extends Disposable implements IAideAgentAccessibilityService {
