...
import type { IChatEditorOptions } from './aideAgentEditor.js';
...
export class ChatEditorInput extends EditorInput {
	...
	static readonly TypeID: string = 'workbench.input.aideAgentSession';
	static readonly EditorID: string = 'workbench.editor.aideAgentSession';
...
export namespace ChatUri {
	...
	export const scheme = Schemas.vscodeAideAgentSesssion;
