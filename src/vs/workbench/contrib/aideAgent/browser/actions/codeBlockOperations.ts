...
import { getReferencesAsDocumentContext } from '../../common/aideAgentCodeMapperService.js';
import { ChatUserAction, IAideAgentService } from '../../common/aideAgentService.js';
...
function notifyUserAction(chatService: IAideAgentService, context: ICodeBlockActionContext, action: ChatUserAction) {
