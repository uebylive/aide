...
import { clearChatEditor } from './actions/aideAgentClear.js';
...
import { IChatModel, IExportableChatData, ISerializableChatData } from '../common/aideAgentModel.js';
...
export class ChatEditor extends EditorPane {
	...
	private updateModel(model: IChatModel, viewState?: IChatViewState): void {
		this._memento = new Memento('aide-agent-session-editor-' + CHAT_PROVIDER_ID, this.storageService);
