...
import { ChatEditingSessionState, IAideAgentEditingService, IChatEditingSession, IChatEditingSessionStream, IModifiedFileEntry } from '../common/aideAgentEditingService.js';

const acceptedChatEditingResourceContextKey = new RawContextKey<string[]>('acceptedAideAgentEditingResource', []);
const chatEditingResourceContextKey = new RawContextKey<string | undefined>('aideAgentEditingResource', undefined);
const inChatEditingSessionContextKey = new RawContextKey<boolean | undefined>('inAideAgentEditingSession', undefined);

export class ChatEditingService extends Disposable implements IAideAgentEditingService {
