...
export const searchToggleSearchType = registerIcon('search-toggle-search-type', Codicon.wand, localize('searchToggleSearchType', 'Icon for toggling search type in the search view.'));
