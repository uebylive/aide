...
export const UseSemanticSearchActionId = 'search.action.useSemanticSearch';
export const UseLexicalSearchActionId = 'search.action.useLexicalSearch';
...
export const IsSemanticSearchKey = new RawContextKey<boolean>('isSemanticSearch', false);
