...
import { IAideChatProgressResponseContent, IChatRequestVariableData, ISerializableChatAgentData } from '../../../../workbench/contrib/aideChat/common/aideChatModel.js';
import { IRawChatCommandContribution, RawChatParticipantLocation } from '../../../../workbench/contrib/aideChat/common/aideChatParticipantContribTypes.js';
import { IAideChatFollowup, IAideChatProgress, IAideChatResponseErrorDetails, IAideChatTaskDto } from '../../../../workbench/contrib/aideChat/common/aideChatService.js';
