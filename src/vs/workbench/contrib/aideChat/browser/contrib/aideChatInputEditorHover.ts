...
import { ChatEditorHoverWrapper } from 'vs/workbench/contrib/aideChat/browser/contrib/editorHoverWrapper';
import { IChatAgentData } from 'vs/workbench/contrib/aideChat/common/aideChatAgents';
import { extractAgentAndCommand } from 'vs/workbench/contrib/aideChat/common/aideChatParserTypes';
