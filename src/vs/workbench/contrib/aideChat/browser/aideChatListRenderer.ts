...
import { ChatTreeItem, GeneratingPhrase, IChatCodeBlockInfo, IChatFileTreeInfo } from '../../../../workbench/contrib/aideChat/browser/aideChat.js';
import { ChatAgentHover, getChatAgentHoverOptions } from '../../../../workbench/contrib/aideChat/browser/aideChatAgentHover.js';
import { ChatCommandButtonContentPart } from '../../../../workbench/contrib/aideChat/browser/chatContentParts/aideChatCommandContentPart.js';
import { ChatConfirmationContentPart } from '../../../../workbench/contrib/aideChat/browser/chatContentParts/aideChatConfirmationContentPart.js';
...
import { ChatMarkdownContentPart, EditorPool } from '../../../../workbench/contrib/aideChat/browser/chatContentParts/aideChatMarkdownContentPart.js';
...
import { ChatTaskContentPart } from '../../../../workbench/contrib/aideChat/browser/chatContentParts/aideChatTaskContentPart.js';
import { ChatTextEditContentPart, DiffEditorPool } from '../../../../workbench/contrib/aideChat/browser/chatContentParts/aideChatTextEditContentPart.js';
import { ChatTreeContentPart, TreePool } from '../../../../workbench/contrib/aideChat/browser/chatContentParts/aideChatTreeContentPart.js';
import { ChatWarningContentPart } from '../../../../workbench/contrib/aideChat/browser/chatContentParts/aideChatWarningContentPart.js';
...
import { ChatCodeBlockContentProvider } from '../../../../workbench/contrib/aideChat/browser/codeBlockPart.js';
import { AideChatAgentLocation, IAideChatAgentMetadata } from '../../../../workbench/contrib/aideChat/common/aideChatAgents.js';
import { CONTEXT_CHAT_RESPONSE_SUPPORT_ISSUE_REPORTING, CONTEXT_REQUEST, CONTEXT_RESPONSE, CONTEXT_RESPONSE_DETECTED_AGENT_COMMAND, CONTEXT_RESPONSE_FILTERED, CONTEXT_RESPONSE_VOTE } from '../../../../workbench/contrib/aideChat/common/aideChatContextKeys.js';
import { IChatTextEditGroup } from '../../../../workbench/contrib/aideChat/common/aideChatModel.js';
import { chatSubcommandLeader } from '../../../../workbench/contrib/aideChat/common/aideChatParserTypes.js';
import { AideChatAgentVoteDirection, IAideChatConfirmation, IAideChatFollowup, IAideChatTask, IChatTreeData } from '../../../../workbench/contrib/aideChat/common/aideChatService.js';
import { IChatReferences, IChatRendererContent, IChatResponseViewModel, IChatWelcomeMessageViewModel, isRequestVM, isResponseVM, isWelcomeVM } from '../../../../workbench/contrib/aideChat/common/aideChatViewModel.js';
import { getNWords } from '../../../../workbench/contrib/aideChat/common/aideChatWordCounter.js';
...
export class ChatListItemRenderer extends Disposable implements ITreeRenderer<ChatTreeItem, FuzzyScore, IChatListItemTemplate> {
	...
	renderTemplate(container: HTMLElement): IChatListItemTemplate {
		...
		const rowContainer = dom.append(container, $('.cschat-item-container'));
		...
		if (this.rendererOptions.noHeader) {
			...
			titleToolbar = templateDisposables.add(scopedInstantiationService.createInstance(MenuWorkbenchToolBar, toolbarParent ?? header, MenuId.AideChatMessageTitle, {
				menuOptions: {
	...
	private renderProgressTask(task: IAideChatTask, templateData: IChatListItemTemplate, context: IChatContentPartRenderContext): IChatContentPart | undefined {
		if (!isResponseVM(context.element)) {
			return;
		}
	...
	private renderConfirmation(context: IChatContentPartRenderContext, confirmation: IAideChatConfirmation, templateData: IChatListItemTemplate): IChatContentPart {
