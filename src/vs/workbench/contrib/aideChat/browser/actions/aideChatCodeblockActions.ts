...
import { DocumentContextItem, WorkspaceEdit } from '../../../../../editor/common/languages.js';
...
import { IUntitledTextResourceEditorInput } from '../../../../../workbench/common/editor.js';
import { accessibleViewInCodeBlock } from '../../../../../workbench/contrib/accessibility/browser/accessibilityConfiguration.js';
import { CHAT_CATEGORY } from '../../../../../workbench/contrib/aideChat/browser/actions/aideChatActions.js';
import { IAideChatWidgetService, IAideChatCodeBlockContextProviderService } from '../../../../../workbench/contrib/aideChat/browser/aideChat.js';
import { DefaultChatTextEditor, ICodeBlockActionContext, ICodeCompareBlockActionContext } from '../../../../../workbench/contrib/aideChat/browser/codeBlockPart.js';
import { CONTEXT_IN_CHAT_INPUT, CONTEXT_IN_CHAT_SESSION, CONTEXT_CHAT_ENABLED, CONTEXT_CHAT_EDIT_APPLIED } from '../../../../../workbench/contrib/aideChat/common/aideChatContextKeys.js';
import { ChatCopyKind, IAideChatService, IDocumentContext } from '../../../../../workbench/contrib/aideChat/common/aideChatService.js';
import { IChatResponseViewModel, isResponseVM } from '../../../../../workbench/contrib/aideChat/common/aideChatViewModel.js';
import { insertCell } from '../../../../../workbench/contrib/notebook/browser/controller/cellOperations.js';
import { INotebookEditor } from '../../../../../workbench/contrib/notebook/browser/notebookBrowser.js';
import { CellKind, NOTEBOOK_EDITOR_ID } from '../../../../../workbench/contrib/notebook/common/notebookCommon.js';
import { ITerminalEditorService, ITerminalGroupService, ITerminalService } from '../../../../../workbench/contrib/terminal/browser/terminal.js';
