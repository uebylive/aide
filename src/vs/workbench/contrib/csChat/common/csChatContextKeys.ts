...
export const CONTEXT_CHAT_EDIT_IN_PROGRESS = new RawContextKey<boolean>('chatSessionEditInProgress', false, { type: 'boolean', description: localize('interactiveSessionEditInProgress', "True when the current edit request is still in progress.") });
