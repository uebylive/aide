...
import { ChatTreeItem, ICSChatAccessibilityService, ICSChatWidgetService, IChatCodeBlockInfo, IChatFileTreeInfo, IChatWidget, IChatWidgetViewContext, IChatWidgetViewOptions } from 'vs/workbench/contrib/csChat/browser/csChat';
