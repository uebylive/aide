...
import { ICSChatWidgetService, ICSHoverChatService } from 'vs/workbench/contrib/csChat/browser/csChat';
...
export class HoverChatService extends Disposable implements ICSHoverChatService {
