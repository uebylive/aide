...
export const CONTEXT_PROBE_HAS_STARTING_POINT = new RawContextKey<boolean>('aideProbeHasStartingPoint', false, { type: 'boolean', description: localize('aideProbeHasStartingPoint', "True when the AI search has a starting point.") });
