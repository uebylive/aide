...
import { IChatCommandGroup, IChatEditsInfo, IChatPlanInfo, IChatPlanStep } from '../../aideAgent/common/aideAgentService.js';
...
export type IAideChatProgressResponseContent = IChatPlanStep | IChatCommandGroup | IChatEditsInfo | IChatPlanInfo;
