...
import { IChatEditsInfo, IChatPlanStep, IChatPlanUpdate } from '../../aideAgent/common/aideAgentService.js';
...
export type IAideChatProgressResponseContent = IChatPlanStep | IChatPlanUpdate | IChatEditsInfo;
