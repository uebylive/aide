...
import { IChatCommandGroup, IChatEditsInfo, IChatPlanStep } from '../../aideAgent/common/aideAgentService.js';
...
export type IAideChatProgressResponseContent = IChatPlanStep | IChatCommandGroup | IChatEditsInfo;
