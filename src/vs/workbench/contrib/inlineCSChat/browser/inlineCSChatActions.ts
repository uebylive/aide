...
export class ViewInChatAction extends AbstractInlineChatAction {
	constructor() {
		super({
			...
			menu: {
				id: MENU_INLINE_CHAT_WIDGET_STATUS,
				when: CTX_INLINE_CHAT_LAST_RESPONSE_TYPE.isEqualTo(ChatEditResponseType.Message),
				group: '0_main',
				order: 1
			}
		});
