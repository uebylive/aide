...
import { EditMode, IInlineCSChatSessionProvider, IInlineCSChatSession, IInlineCSChatBulkEditResponse, IInlineCSChatEditResponse, IInlineCSChatMessageResponse, IInlineCSChatResponse, IInlineCSChatService } from 'vs/workbench/contrib/inlineCSChat/common/inlineCSChat';
...
export class MarkdownResponse {
	constructor(
		...
		readonly raw: IInlineCSChatMessageResponse,
