...
import { IInlineCSChatService } from 'vs/workbench/contrib/inlineCSChat/common/inlineCSChat';
...
export class InlineChatDecorationsContribution extends Disposable implements IEditorContribution {
	...
	constructor(
		...
		super();
		const keybindings = _keybindingService.lookupKeybinding('inlineCSChat.start')?.getLabel();
