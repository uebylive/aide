...
import { defaultKeybindingsContents, DefaultKeybindingsEditorModel, DefaultModelSelectionEditorModel, DefaultRawSettingsEditorModel, DefaultSettings, DefaultSettingsEditorModel, Settings2EditorModel, SettingsEditorModel, WorkspaceConfigurationEditorModel } from '../common/preferencesModels.js';
...
import { ModelSelectionEditorInput } from './modelSelectionEditorInput.js';
...
export class PreferencesService extends Disposable implements IPreferencesService {
	...
	getDefaultSettingsContent(uri: URI): string | undefined {
		...
		if (isEqual(uri, this.defaultModelSelectionsResource)) {
			...
			return defaultModelSelectionSettingsEditorModel.content;
		}
