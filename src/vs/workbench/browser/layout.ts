...
import { Position, Parts, PanelOpensMaximizedOptions, IWorkbenchLayoutService, positionFromString, positionToString, panelOpensMaximizedFromString, PanelAlignment, ActivityBarPosition, LayoutSettings, MULTI_WINDOW_PARTS, SINGLE_WINDOW_PARTS, ZenModeSettings, EditorTabsMode, EditorActionsLocation, shouldShowCustomTitleBar, isHorizontal, OverlayedParts } from '../services/layout/browser/layoutService.js';
...
import { IObservableView, Part } from './part.js';
...
import { OverlayedPart, IOverlayedView } from './overlayedPart.js';
...
export abstract class Layout extends Disposable implements IWorkbenchLayoutService {
	...
	//private aideBarPartView!: ISerializableView;
	...
	getMaximumEditorDimensions(container: HTMLElement): IDimension {
		...
		if (container === this.mainContainer) {
			...
			// = this.aideBarPartView.minimumWidth;
	...
	protected createWorkbenchLayout(): void {
		...
		//const aideBarPart = this.getPart(Parts.AIDEBAR_PART);
		...
		//this.aideBarPartView = aideBarPart;
		...
		const viewMap = {
			...
			[OverlayedParts.AIDECONTROLS_PART]: this.aideControlsPartView,
			//[Parts.AIDEBAR_PART]: this.aideBarPartView,
	...
	private createGridDescriptor(): ISerializedGrid {
		...
		//	type: 'leaf',
		//	data: { type: OverlayedParts.AIDECONTROLS_PART },
		//	size: 36,
		//	visible: true
		//};
