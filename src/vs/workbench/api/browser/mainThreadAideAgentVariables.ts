...
import { IChatRequestVariableValue, IChatVariableData, IChatVariableResolverProgress, IAideAgentVariablesService } from '../../contrib/aideAgent/common/aideAgentVariables.js';
import { IExtHostContext, extHostNamedCustomer } from '../../services/extensions/common/extHostCustomers.js';

@extHostNamedCustomer(MainContext.MainThreadAideAgentVariables)
export class MainThreadChatVariables implements MainThreadChatVariablesShape {
	...
	constructor(
		...
		@IAideAgentVariablesService private readonly _chatVariablesService: IAideAgentVariablesService,
	) {
		this._proxy = extHostContext.getProxy(ExtHostContext.ExtHostAideAgentVariables);
	}
