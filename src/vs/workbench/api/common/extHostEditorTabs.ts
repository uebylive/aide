...
import { AideChatEditorTabInput, ChatEditorTabInput, CustomEditorTabInput, InteractiveWindowInput, NotebookDiffEditorTabInput, NotebookEditorTabInput, TerminalEditorTabInput, TextDiffTabInput, TextMergeTabInput, TextTabInput, WebviewEditorTabInput, TextMultiDiffTabInput } from 'vs/workbench/api/common/extHostTypes';
...
type AnyTabInput = TextTabInput | TextDiffTabInput | TextMultiDiffTabInput | CustomEditorTabInput | NotebookEditorTabInput | NotebookDiffEditorTabInput | WebviewEditorTabInput | TerminalEditorTabInput | InteractiveWindowInput | ChatEditorTabInput | AideChatEditorTabInput;
...
class ExtHostEditorTab {
	...
	private _initInput() {
		switch (this._dto.input.kind) {
			...
			case TabInputKind.AideChatEditorInput:
				return new AideChatEditorTabInput();
