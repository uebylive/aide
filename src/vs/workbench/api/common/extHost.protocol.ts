...
import { IAideProbeBreakdownContent, IAideProbeData, IAideProbeGoToDefinition, IAideProbeRequestModel, IAideProbeResult, IAideProbeTextEdit, IAideProbeTextEditPreview, IAideProbeUserAction } from 'vs/workbench/contrib/aideProbe/common/aideProbe';
...
export type IAideProbeProgressDto = Dto<IAideChatMarkdownContent | IAideProbeBreakdownContent | IAideProbeGoToDefinition | IAideProbeTextEditPreview> | IAideProbeTextEditDto;
