...
import { IChatCodeEdit, IChatCommandButton as IAideChatCommandButton, IChatCommandGroup, IChatEditsInfo, IChatEndResponse, IChatPlanStep, IChatStreamingState, IChatPlanInfo, IChatThinkingForEditPart } from '../../contrib/aideAgent/common/aideAgentService.js';
...
export type IAideChatProgressDto = Dto<IChatEditsInfo | IChatStreamingState | IAideChatCommandButton | IChatCommandGroup | IChatPlanStep | IChatPlanInfo | IChatEndResponse | IChatThinkingForEditPart>;
