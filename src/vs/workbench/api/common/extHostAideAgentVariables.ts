...
import { IChatRequestVariableValue, IChatVariableData } from '../../contrib/aideAgent/common/aideAgentVariables.js';
import { checkProposedApiEnabled } from '../../services/extensions/common/extensions.js';
import type * as vscode from 'vscode';

export class ExtHostAideAgentVariables implements ExtHostChatVariablesShape {
	...
	constructor(mainContext: IMainContext) {
		this._proxy = mainContext.getProxy(MainContext.MainThreadAideAgentVariables);
	}
	...
	registerVariableResolver(extension: IExtensionDescription, id: string, name: string, userDescription: string, modelDescription: string | undefined, isSlow: boolean | undefined, resolver: vscode.ChatVariableResolver, fullName?: string, themeIconId?: string): IDisposable {
		const handle = ExtHostAideAgentVariables._idPool++;
