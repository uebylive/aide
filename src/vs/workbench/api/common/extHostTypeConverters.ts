...
import { IAideChatAgentDetection, IAideChatAgentMarkdownContentWithVulnerability, IAideChatCommandButton, IAideChatConfirmation, IAideChatContentInlineReference, IAideChatContentReference, IAideChatFollowup, IAideChatMarkdownContent, IAideChatProgressMessage, IAideChatTaskDto, IAideChatTaskResult, IAideChatTextEdit, IAideChatUserActionEvent, IAideChatWarningMessage } from '../../contrib/aideChat/common/aideChatService.js';
import { IAideChatAgentRequest, AideChatAgentLocation, IAideChatAgentResult } from '../../contrib/aideChat/common/aideChatAgents.js';
import { IAideChatRequestVariableEntry } from '../../contrib/aideChat/common/aideChatModel.js';
...
export namespace AideProbeRequestModel {
	export function to(request: IAideProbeRequestModel): vscode.ProbeRequest {
		return {
			...
			references: request.variableData.variables.map(AideChatAgentValueReference.to),
			mode: request.mode,
