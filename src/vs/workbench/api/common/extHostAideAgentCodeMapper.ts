...
import { ICodeMapperResult } from '../../contrib/aideAgent/common/aideAgentCodeMapperService.js';
import * as extHostProtocol from './extHost.protocol.js';
import { TextEdit } from './extHostTypeConverters.js';
import { URI } from '../../../base/common/uri.js';

export class ExtHostAideAgentCodeMapper implements extHostProtocol.ExtHostCodeMapperShape {
	...
	constructor(
		...
		this._proxy = mainContext.getProxy(extHostProtocol.MainContext.MainThreadAideAgentCodeMapper);
	}
	...
	registerMappedEditsProvider(extension: IExtensionDescription, provider: vscode.MappedEditsProvider2): vscode.Disposable {
		const handle = ExtHostAideAgentCodeMapper._providerHandlePool++;
