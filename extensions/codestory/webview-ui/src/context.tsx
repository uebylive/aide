...
export const ExplorationContextProvider = ({
  ...
  const [activeExploration, setActiveExploration] = useState(exploration || defaultExploration);
  ...
  return (
    <ExplorationContext.Provider value={{ exploration: activeExploration, setExploration }}>
      {children}
