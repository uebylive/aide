...
const localModelPath = RUNNING_LOCALLY
    ? path.join(dirname, DEFAULT_LOCAL_MODEL_PATH)
 ...
 * @property {string} dirname Directory name of module. Useful for resolving local paths.
